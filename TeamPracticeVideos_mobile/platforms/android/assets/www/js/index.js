var app = {
    ...
    win(r) {
        if (typeof r.responseCode != "undefined") {
            console.log("Code = " + r.responseCode);
            if (r.responseCode == 200) {
                alert("Successsfully uploaded your video to www.teampracticevideos.com!");
            }
        }
    ...
    fail(error) {
        alert("upload error source " + error.code);
        alert("upload error target " + error.body);
        alert("upload error source " + error.getMessage);
    },
